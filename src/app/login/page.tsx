      ...
      <div className="pt-24 pb-20 flex flex-col items-center px-4">
        ...
        <div className="flex items-center gap-4 text-sm font-semibold tracking-[0.25em]">
          <button
            ...
            className={mode === 'login' ? 'text-black' : 'text-gray-400 hover:text-black transition'}
          >
            CONNEXION
          </button>
          ...
          <button
            ...
            className={mode === 'register' ? 'text-black' : 'text-gray-400 hover:text-black transition'}
          >
            INSCRIPTION
          </button>
        </div>
        ...
        {error && (
          <div className="mt-6 bg-red-500 text-white px-4 py-2 rounded-xl text-sm">
            {error}
          </div>
        )}
        {success && (
          <div className="mt-6 bg-green-500 text-white px-4 py-2 rounded-xl text-sm">
            {success}
          </div>
        )}
        ...
        >
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className={`flex-1 py-3 rounded-xl font-semibold text-sm border-2 transition ${
                    role === 'CONSUMER' ? 'bg-[#6A00FF] text-white border-[#6A00FF]' : 'bg-white text-black border-gray-200'
                  }`}
                >
                  Un acheteur
                </button>
                <button
                  ...
                  className={`flex-1 py-3 rounded-xl font-semibold text-sm border-2 transition ${
                    role === 'BRAND' ? 'bg-[#6A00FF] text-white border-[#6A00FF]' : 'bg-white text-black border-gray-200'
                  }`}
                >
                  Une marque
                </button>
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-6 w-full rounded-xl bg-[#6A00FF] py-3 text-white font-semibold text-base disabled:opacity-50 hover:opacity-90 transition"
          >
